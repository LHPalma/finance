CREATE TABLE user_address (
    ...
    zip_code_verification_status VARCHAR(25) NOT NULL DEFAULT 'NOT_VERIFIED',
...
CREATE UNIQUE INDEX uk_user_address_primary_by_type ON user_address (user_id, type) WHERE is_primary = TRUE;
