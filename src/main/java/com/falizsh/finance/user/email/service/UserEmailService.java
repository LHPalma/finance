package com.falizsh.finance.user.email.service;

import com.falizsh.finance.user.email.assembler.UserEmailAssembler;
...
public class UserEmailService {
    ...
    public List<UserEmail> findByUserId(Long userId) {
