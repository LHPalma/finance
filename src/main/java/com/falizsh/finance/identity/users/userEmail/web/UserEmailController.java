package com.falizsh.finance.identity.users.userEmail.web;

import com.falizsh.finance.identity.users.userEmail.assembler.UserEmailAssembler;
import com.falizsh.finance.identity.users.userEmail.dto.UserEmailCreateDTO;
import com.falizsh.finance.identity.users.userEmail.dto.UserEmailResponseDTO;
import com.falizsh.finance.identity.users.userEmail.model.UserEmail;
import com.falizsh.finance.identity.users.userEmail.repository.UserEmailCommand;
